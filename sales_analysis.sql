...
FROM 'D:\Data Science\Projects\SQL\Walmart_sales_analysis\sales.csv'
	WITH (
		FIRSTROW=2,
		FIELDTERMINATOR=',',
		ROWTERMINATOR='\n'
...
--1st :- Creating Copy Table

select * into sales from sales_store;
select * from sales;


--2nd :- Handeling Duplicate Values (Rows)
...
--3rd :- Correction of Headers (column names)
...
--Business Problem: Finding peak sales times.

--Business Impact: Optimize staffing, promotions, and stock loads.
